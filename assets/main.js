...
$(window).scroll(function() {
      if ($(this).scrollTop() > 20) {
        ...
        $('.header-v5 .logo-header5').addClass("logo-hidden");
          ...
          $('.header-v6').removeClass("space_top_bot_20").addClass("fixed").addClass("bg-header-v1").addClass("full-width");
          $('.header-v7').removeClass("space_top_bot_0").addClass("fixed").addClass("bg-header-v1").addClass("full-width");
          ...
          $('.header-v6').addClass("space_top_bot_20").removeClass("fixed").removeClass("bg-header-v1").removeClass("full-width");
          $('.header-v7').addClass("space_top_bot_0").removeClass("fixed").removeClass("bg-header-v1").removeClass("full-width");
